...
const TRACKER = [
  ...
  {n:"Martin Daly",p:"FF",con:"Roscommon–Galway",j:"ROI",status:"generic",responded:"2026-03-04",summary:"Staffer acknowledgment. 'Fully supports all initiatives aimed at making our roads safer.' No engagement with five demands. As a GP, has seen first-hand impact — but no specific commitments."},
  {n:"Roderic O'Gorman",p:"GP",con:"Dublin West",j:"ROI",status:"meaningful",responded:"2026-03-04",summary:"Agreed road safety is consistently disregarded. Frustrated by RSA reform rollback. Offered to help get oral evidence at Joint Oireachtas Committee on Transport. Asked if research submitted to Committee."},
  {n:"Grace Boland",p:"FG",con:"Dublin Fingal West",j:"ROI",status:"meaningful",responded:"2026-03-04",summary:"Committing to table Parliamentary Questions on road safety. Will share Minister's responses when received."},
];
