...
const INCIDENTS = [
  {date:"15 Aug",loc:"Co Galway",desc:"Motorcyclist killed in collision; pronounced dead at the scene. Fourth motorcyclist killed in a fortnight — the 116th road death of 2026.",type:"motorcyclist",lat:53.30,lng:-8.90},
  {date:"7 Aug",loc:"N56, Termon, Co Donegal",desc:"Motorcyclist (60s) killed in collision with a car.",type:"motorcyclist",lat:55.05,lng:-7.83},
  {date:"5 Aug",loc:"R587, Gloun North, Dunmanway, Co Cork",desc:"Motorcyclist (50s) killed in collision with a van.",type:"motorcyclist",lat:51.72,lng:-9.11},
  {date:"2 Aug",loc:"R448, Ballyknockan, Leighlinbridge, Co Carlow",desc:"Motorcyclist (40s) died in hospital after collision with a car at 9:30am. Airlifted to the Mater.",type:"motorcyclist",lat:52.74,lng:-6.98},
  {date:"18 Jul",loc:"Glenariffe Road, near Ballymena, Co Antrim",desc:"Natasha 'Tash' Gove (31), young mother, passenger, and male driver (41) both killed when Ford Transit van crashed in single-vehicle collision at 9pm.",type:"passenger",lat:55.05,lng:-6.07},
  {date:"4 Jul",loc:"N20, Castlewrixon, near Ballyhea, Co Cork",desc:"Male motorcyclist (30s) pronounced dead at scene following collision with jeep at 8pm. Jeep driver (80s) taken to CUH.",type:"motorcyclist",lat:52.28,lng:-8.66},
  {date:"4 Jul",loc:"Killick, Kilcock, Co Kildare",desc:"Male motorcyclist (50s) fatally injured in single-vehicle collision at 10:45am.",type:"motorcyclist",lat:53.40,lng:-6.67},
  {date:"4 Jul",loc:"Co Donegal",desc:"One person killed in collision — third fatality in a single day across the State.",type:"driver",lat:54.90,lng:-7.90},
  {date:"21 May",loc:"Drumcondra Road Lower, Dublin",desc:"Two people killed in collision.",type:"driver",lat:53.37,lng:-6.26},
  {date:"18 May",loc:"R702, Enniscorthy, Co Wexford",desc:"One person killed in collision.",type:"driver",lat:52.50,lng:-6.57},
  {date:"17 May",loc:"N15, Birchill, Co Donegal",desc:"Two men (20s and 30s) killed in two-vehicle collision at 2pm. Four others injured and taken to Letterkenny University Hospital.",type:"driver",lat:54.78,lng:-7.90},
  {date:"16 May",loc:"N11, Loughlinstown, Co Dublin",desc:"One person killed in collision.",type:"driver",lat:53.24,lng:-6.14},
  {date:"16 May",loc:"N15, Ballybofey, Co Donegal",desc:"Two people killed in collision.",type:"driver",lat:54.80,lng:-7.79},
  {date:"13 May",loc:"R495, Nenagh, Co Tipperary",desc:"One person killed in collision.",type:"driver",lat:52.86,lng:-8.20},
  {date:"9 May",loc:"N15, Rathcormack, Co Sligo",desc:"Two people killed in collision.",type:"driver",lat:54.22,lng:-8.50},
  {date:"8 May",loc:"L4016, Adamstown, Co Wexford",desc:"One person killed in collision.",type:"driver",lat:52.35,lng:-6.65},
  {date:"3 May",loc:"Carrickaboy, Co Cavan",desc:"One person killed in collision on local road.",type:"driver",lat:53.88,lng:-7.30},
  {date:"29 Apr",loc:"R591, Co Cork",desc:"One person killed in collision.",type:"driver",lat:51.90,lng:-8.60},
  {date:"29 Apr",loc:"Ballinasloe, Co Galway",desc:"One person killed in collision on local road.",type:"driver",lat:53.33,lng:-8.23},
  {date:"27 Apr",loc:"Ballymote, Co Sligo",desc:"Two people killed in collision on local road.",type:"driver",lat:54.09,lng:-8.52},
  ...
  {date:"26 Apr",loc:"Knocklyon, Co Dublin",desc:"One person killed in collision on local road.",type:"driver",lat:53.29,lng:-6.33},
  ...
  {date:"25 Apr",loc:"R252, Cloghan, Co Donegal",desc:"One person killed in collision.",type:"driver",lat:54.70,lng:-7.85},
  {date:"24 Apr",loc:"Moyvane, Co Kerry",desc:"One person killed in collision on main road.",type:"driver",lat:52.47,lng:-9.44},
  {date:"23 Apr",loc:"Dublin Airport, Co Dublin",desc:"Man (60s), pedestrian, killed in collision with bus on main road leading to Dublin Airport just after midnight. Pronounced dead at scene.",type:"pedestrian",lat:53.43,lng:-6.25},
  ...
  {date:"18 Apr",loc:"R126, Clondalkin, Co Dublin",desc:"One person killed in collision.",type:"driver",lat:53.32,lng:-6.39},
  {date:"17 Apr",loc:"Little Island, Co Cork",desc:"One person killed in collision on local road.",type:"driver",lat:51.90,lng:-8.35},
  {date:"15 Apr",loc:"Bellews Bridge Road, Castletown, Co Louth",desc:"One person killed in collision.",type:"driver",lat:53.92,lng:-6.50},
  {date:"15 Apr",loc:"Ballymote to Tubbercurry Road, Co Sligo",desc:"One person killed in collision.",type:"driver",lat:54.05,lng:-8.55},
  {date:"6 Apr",loc:"Castletownroche, Co Cork",desc:"One person killed in collision on local road.",type:"driver",lat:52.18,lng:-8.45},
  {date:"6 Apr",loc:"N53, Rassan, Dundalk, Co Louth",desc:"Man in his 60s killed in two-vehicle collision at 10:15pm.",type:"driver",lat:54.04,lng:-6.56},
  {date:"5 Apr",loc:"Castlecat Road, Dervock, Co Antrim",desc:"Man (20), driver, killed in single-vehicle collision shortly before 1am Easter Sunday.",type:"driver",lat:55.15,lng:-6.37},
  {date:"3 Apr",loc:"Port Road, Letterkenny, Co Donegal",desc:"One person killed in collision.",type:"driver",lat:54.95,lng:-7.74},
  {date:"3 Apr",loc:"Keel, Achill Island, Co Mayo",desc:"Pedestrian killed in early hours of the morning.",type:"pedestrian",lat:53.89,lng:-10.06},
  {date:"2 Apr",loc:"R634, Youghal, Co Waterford",desc:"Motorcyclist (60s) killed in collision.",type:"motorcyclist",lat:51.95,lng:-7.85},
  {date:"2 Apr",loc:"M50, Co Dublin",desc:"One person killed in collision.",type:"driver",lat:53.35,lng:-6.30},
  {date:"1 Apr",loc:"Dublin, Co Dublin",desc:"Cyclist (20s) killed in collision with HGV at O'Connell Street and Middle Abbey Street.",type:"cyclist",lat:53.35,lng:-6.26},
  {date:"1 Apr",loc:"Tramore Road, Co Waterford",desc:"One person killed in collision.",type:"driver",lat:52.24,lng:-7.13},
  {date:"1 Apr",loc:"Castleblayney, Co Monaghan",desc:"Stephen Marron (47) killed in collision.",type:"driver",lat:54.12,lng:-6.73},
  {date:"29 Mar",loc:"Sixmilebridge, Co Clare",desc:"One person killed in collision on L7006.",type:"driver",lat:52.74,lng:-8.77},
  {date:"29 Mar",loc:"M8, Glanmire, Co Cork",desc:"One person killed in collision.",type:"driver",lat:51.91,lng:-8.40},
  {date:"29 Mar",loc:"Drogheda, Co Louth",desc:"One person killed in collision on local road.",type:"driver",lat:53.72,lng:-6.35},
  {date:"29 Mar",loc:"R238, Moville, Co Donegal",desc:"One person killed in collision.",type:"driver",lat:55.19,lng:-7.04},
  {date:"29 Mar",loc:"N69, Tralee, Co Kerry",desc:"One person killed in collision.",type:"driver",lat:52.27,lng:-9.70},
  {date:"28 Mar",loc:"R458, Rathfolan, Newmarket on Fergus, Co Clare",desc:"Woman in her 60s killed in single-vehicle collision at 10:50pm.",type:"driver",lat:52.76,lng:-8.90},
  {date:"30 Mar",loc:"Newry Road, Armagh",desc:"Woman in her 90s killed in two-vehicle collision at 10:30am.",type:"driver",lat:54.35,lng:-6.65},
  {date:"17 Mar",loc:"Marble Arch Road, Florencecourt, Co Fermanagh",desc:"Woman (30s) killed in two-vehicle collision at 9:55pm.",type:"driver",lat:54.27,lng:-7.81},
  {date:"15 Mar",loc:"N4, Ballinafid, Co Westmeath",desc:"Man (20s), driver, killed in single-vehicle collision at 12:50am.",type:"driver",lat:53.58,lng:-7.42},
  {date:"12 Mar",loc:"N51, Boyerstown, Navan, Co Meath",desc:"Woman (40s), passenger, killed in two-car collision at 7:45am. Teenage girl airlifted to Temple Street.",type:"passenger",lat:53.68,lng:-6.72},
  {date:"12 Mar",loc:"M3, Dunshaughlin, Co Meath",desc:"Man (40s), van driver, killed in collision with truck at 2am.",type:"driver",lat:53.51,lng:-6.54},
  {date:"8 Mar",loc:"Dunmurry, Belfast",desc:"James Kilpatrick (55), motorcyclist, killed in single-vehicle collision on Queensway at 7:30am.",type:"motorcyclist",lat:54.55,lng:-5.98},
  {date:"8 Mar",loc:"Tyrrelstown, Dublin",desc:"Man (30s), passenger, killed in single-vehicle collision on Powerstown Road.",type:"driver",lat:53.41,lng:-6.38},
  {date:"1 Mar",loc:"Ballina, Co Mayo",desc:"Fatal single-vehicle collision shortly after 4:15am.",type:"driver",lat:53.76,lng:-9.15},
  {date:"24 Feb",loc:"St Johnston, Co Donegal",desc:"Daniel Cullen (18) and Caoimhín Porter-McLoone (18), both from Derry, killed when car collided with lorry on R236.",type:"driver",lat:54.93,lng:-7.45},
  ...
  {date:"22 Feb",loc:"Tramore Road, Co Waterford",desc:"Brian and Grace Frisby, couple in their 40s, parents of two young sons, killed in two-car collision.",type:"driver",lat:52.23,lng:-7.12},
  ...
  {date:"11 Feb",loc:"Newtownards, Co Down",desc:"Man (50s), pedestrian, struck by car on Kempe Stones Road.",type:"pedestrian",lat:54.59,lng:-5.69},
  {date:"4 Jan",loc:"N4, Edgeworthstown, Co Longford",desc:"Francis 'Franco' Kelly (30s), first ROI road death of 2026.",type:"driver",lat:53.70,lng:-7.60},
...
const YR=[{y:"2019",r:141,n:55,t:196},{y:"2020",r:149,n:50,t:199},{y:"2021",r:137,n:50,t:187},{y:"2022",r:155,n:62,t:217},{y:"2023",r:184,n:71,t:255},{y:"2024",r:175,n:69,t:244},{y:"2025",r:190,n:57,t:247},{y:"2026*",r:116,n:42,t:158,proj:true,pace:260}];
...
const TRACKER = [
  ...
  {n:"Brian Brennan",p:"FG",con:"Wicklow–Wexford",j:"ROI",status:"generic",responded:"2026-04-18",summary:"'Happy to bring initiatives to Minister.' Tabled generic PQ on behalf of constituent — got copy-paste Phase 2 Action Plan answer. No personal commitment to five demands."},
...
const PQS = [
  ...
  // === MAY 2026 ===
  {td:"Donna McGettigan",p:"SF",con:"Clare",date:"2026-05-12",type:"Written",
   q:"To ask the Minister for Transport further to Parliamentary Question No. 335 of 28 April 2026, whether the Government has conducted any assessment of deploying 500 or more fixed speed cameras to match the enforcement density of Finland (1,164 cameras) or Sweden (2,487 cameras); if not, the reasons for same; and if he will make a statement on the matter.",
  ...
  {td:"Brian Brennan",p:"FG",con:"Wicklow–Wexford",date:"2026-04-23",type:"Written",
   q:"To ask the Minister for Transport the actions he will take to improve road safety given the increase in road deaths in recent years; and if he will make a statement on the matter.",
   status:"answered",answered:"2026-04-23",minister:"Seán Canney",
   response:"Phase 2 Action Plan 2025–2027: 12 primary actions, 77 supporting actions. Key deliverables: NVDF Bill to allow LAs to resume collision data, learner permit repeat renewal regs (November). Camera strategy 'shortly.' €18m RSA awareness campaigns. 'My focus as Minister... is on the delivery of the Phase 2 Action Plan.'",
   assessment:"Generic question, copy-paste answer. Tabled on behalf of constituent. Lists 89 actions across multiple agencies with no single accountable body. Camera strategy 'shortly' — published 6 days later (29 April) but with no target numbers. NVDF Bill still a 'key deliverable' but still not published. €18m on awareness while deaths rise 31%."},
];
...
export default function App(){
  ...
  return(<div style={{minHeight:"100vh",background:"#0a0a0a",color:"#fff",fontFamily:F.b}}>
    ...
    <div style={{borderBottom:"1px solid #282828",padding:"12px 20px",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8}}>
      ...
      <div style={{fontFamily:F.m,fontSize:10,color:"#999"}}>ALL-ISLAND · RSA + PSNI · AUG 2026</div>
    </div>
    <Counter/>
    ...
    <div style={{maxWidth:1100,margin:"0 auto",padding:"20px"}}>
      ...
      {tab==="latest"&&(<div style={{maxWidth:600,margin:"0 auto"}}>
        <div style={{background:"#ff1a1a10",border:"1px solid #ff1a1a30",borderRadius:4,padding:"20px 24px",marginBottom:16,textAlign:"center"}}>
          <div style={{fontFamily:F.h,fontSize:56,color:X.r}}>158+</div>
          ...
          <div style={{display:"flex",justifyContent:"center",gap:28,marginTop:14}}>
            <div style={{textAlign:"center"}}><div style={{fontFamily:F.h,fontSize:36,color:X.r}}>116</div><div style={{fontFamily:F.m,fontSize:11,color:X.t}}>REPUBLIC · TO 14 AUG</div></div>
            <div style={{width:1,background:"#444"}}/>
            <div style={{textAlign:"center"}}><div style={{fontFamily:F.h,fontSize:36,color:X.o}}>42</div><div style={{fontFamily:F.m,fontSize:11,color:X.t}}>NI · TO 27 JUL</div></div>
          </div>
          <div style={{fontFamily:F.b,fontSize:14,color:X.t,marginTop:12}}>The Republic hit 116 dead by 14 August — 13 ahead of last year's pace, in a year that ended at 190. NI deaths are up 56% — 42 by late July vs 27 in 2025. At this rate, 2026 will be the deadliest year on the island in over a decade.</div>
        </div>
        ...
        <div style={{background:"#1a0a0a",border:"1px solid rgba(255,26,26,0.3)",borderRadius:4,padding:"16px 20px",marginBottom:16}}>
          <div style={{fontFamily:F.h,fontSize:18,color:X.r,marginBottom:4}}>"CARNAGE" — THE PSNI'S OWN WORD · JULY 2026</div>
          <div style={{fontFamily:F.b,fontSize:13,color:X.t,lineHeight:1.6}}>PSNI Chief Superintendent Norman Haslett, launching a road safety day of action on 28 July: "I don't use the word carnage lightly... This year we have lost 42 people on the roads of Northern Ireland. Once every five days police officers are knocking on doors to tell families that their loved ones are gone. If we lost 42 people in any other circumstances there would be a public outcry — but here we seem to have some sort of societal apathy." NI deaths are up 56% on 2025. In the Republic, 116 people had been killed by 14 August — 13 ahead of last year's pace. Eleven people died in the 17 days to 14 August alone, including four motorcyclists in a fortnight. RSA research shows 57% of this year's fatal collisions (to 26 July) occurred on roads with limits of 80km/h or more, and over a quarter of those killed were aged 16–25. Sligo councillor Marie Casserly has written to the Taoiseach demanding a national emergency be declared.</div>
        </div>
        {/* Incidents */}
        ...
        <div style={{background:"#0a1a1a",border:"1px solid rgba(78,205,196,0.3)",borderRadius:6,padding:"18px 22px",marginBottom:10}}>
          ...
          <div style={{display:"flex",gap:0,marginBottom:12,position:"relative"}}>
            {[{date:"MAY 2025",promise:"'Enacted by year-end'",who:"Canney to JOC",missed:true},
              {date:"MAY 2026",promise:"'Summer 2026'",who:"Canney to Whitmore",missed:true},
